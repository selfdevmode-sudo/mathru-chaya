...
const dict: Record<string, Record<Lang, string>> = {
  ...
  map_link: {
    en: 'Location map link',
    kn: 'ಸ್ಥಳ ನಕ್ಷೆ ಲಿಂಕ್',
    hi: 'स्थान मानचित्र लिंक',
  },
  ...
  edit_award: {
    en: 'Edit Award',
    kn: 'ಪ್ರಶಸ್ತಿ ಸಂಪಾದಿಸಿ',
    hi: 'पुरस्कार संपादित करें',
  },
  add_award_title: {
    en: 'Add Award',
    kn: 'ಪ್ರಶಸ್ತಿ ಸೇರಿಸಿ',
